...
In order to prepare data for topic modelling, we create Corpus and Document Term Matrix. As with clustering, we remove words related to Australia's geography (such as *australia*, *australian*, *queensland*, *nsw*, *victoria*).
